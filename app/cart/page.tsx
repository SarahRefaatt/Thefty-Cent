...
//     (sum, item) => sum + item.product[0].price * item.quantity,
//     0
//   );
...
//                       <h3 className="text-lg font-medium text-gray-900">{item.product[0].name}</h3>
//                       <p className="text-lg font-semibold text-gray-600 mt-1">${item.product[0].price.toFixed(2)}</p>
...
//                       ${(item.product[0].price * item.quantity).toFixed(2)}
//                     </div>
//                   </div>
//                 ))}
//               </div>
