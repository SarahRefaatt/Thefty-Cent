...
//     //   const updatedCart = fetch('/api/carts?id={id}', {
//     //   method: 'PUT',
//     //   headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ item.cart_id,item.product,item.quantity }  )})
//     //   )
...
//     fetch(`/api/cartItems?id=${id}`, { method: 'DELETE' })
//       .then(res => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
          ...
          <button 
            className="bg-indigo-600 dark:bg-indigo-700 text-white px-6 py-3 rounded-md hover:bg-indigo-700 dark:hover:bg-indigo-600 transition-colors"
            onClick={() => window.history.back()}
          >
            Continue Shopping
          </button>
